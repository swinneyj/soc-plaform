    ...
    components: {
        ...
        'code-review-tab': window.CodeReviewTab
            ...
            methods: {
                ...
                // ---- In-place Find helpers for Code to Review textarea ----
                clearCodeReviewFind() {
